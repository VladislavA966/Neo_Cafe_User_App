...
class _MenuScreenState extends State<MenuScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List categories = ['Кофе', 'Выпечка', 'Напитки', 'Чай', 'Десерты'];

    return Stack(
      children: [
        Scaffold(
          appBar: _buildAppBar(),
          body: _buildBody(categories, childAspectRatio),
        ),
  ...
  Padding _buildBody(List<dynamic> categories, double childAspectRatio) {
    return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildToggleButtonsList(categories),
              const SizedBox(
                height: 20,
              ),
  ...
  Expanded _buildMenuGrid(double childAspectRatio) {
    return Expanded(
  ...
  SizedBox _buildToggleButtonsList(List<dynamic> categories) {
    return SizedBox(
              height: 38,
...
class MenuItem extends StatelessWidget {
  ...
  const MenuItem({super.key, required this.onTap});
